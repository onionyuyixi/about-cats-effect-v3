...
final class WorkStealingThreadPoolConstants {
  ...
  public static void main(String[] args) {
    System.err.println(Integer.toBinaryString(DeltaSearching));
    System.err.println(Integer.toBinaryString(DeltaSearching));
    System.err.println(Integer.toBinaryString(DeltaNotSearching));
    System.err.println(Integer.toBinaryString(-DeltaNotSearching));
    System.err.println(Integer.toBinaryString(SearchMask));
    System.err.println(Integer.toBinaryString(UnparkMask));
  }
